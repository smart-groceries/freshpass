...
export interface OrderRejectedProps {
...
export default class OrderRejected extends React.Component<OrderRejectedProps> {
  render = () => {
    const {style, orderNumber = '0000'} = this.props;
    return (
      <View style={[_container(), style]}>
        ...
        <View style={styles.paragraphContainer}>
          <Text style={styles.paragraph}>
            Your order was rejected by the grocer. Please go back to your cart
            and correct the items that you listed that you have.
          </Text>
          <Text style={styles.paragraph}>
