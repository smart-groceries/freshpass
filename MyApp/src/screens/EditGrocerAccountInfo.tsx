...
const EditGrocerAccountInfoScreen = () => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={[styles.text_header,{marginTop: 60}]}>Account Info</Text>
              ...
              <Text style={[styles.text_footer,{marginTop: 50}, {marginLeft: 17}]}>Company</Text>
              <View style={[styles.action, {marginTop: 14}]}>
              <TextInput
                      placeholder= 'Company'
                      placeholderTextColor='#C8C8C8'
              ...
              <Text style={[styles.text_footer,{marginTop: 50}, {marginLeft: 17}]}>Store Name</Text>
              <View style={[styles.action, {marginTop: 14}]}>
              <TextInput
              ...
              <View style = {[{marginTop: 60}, {justifyContent: 'center'}, {alignItems: 'center'}]}>
                  <Text style={getSavedNotif()}>Grocer Info Saved!</Text>
              </View>
...
export default EditGrocerAccountInfoScreen;